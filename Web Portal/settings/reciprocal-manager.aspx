<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reciprocal-manager.aspx.cs" Inherits="settings_reciprocal_manager" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Digital Display Admin - Reciprocal Club Manager</title>
		<meta charset="utf-8" />
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
						  <h1 class="major">Reciprocal Club Manager</h1>
						  <span class="image fit"><img src="../images/cal-1040.jpg" alt="" /></span>
                          <h2>Current Clubs</h2>
                            <div class="table-wrapper">
                                <asp:Literal ID="clubTable" runat="server" />
                            </div>
                                    
                            <h2>Club Options</h2>
						    <a href="add/add-club.aspx" class="button">Add Club</a>
						</div>
					</section>
