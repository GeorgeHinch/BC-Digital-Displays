<%@ Page Language="C#" AutoEventWireup="true" CodeFile="notification-manager.aspx.cs" Inherits="settings_notification_manager" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Digital Display Admin - Notification Manager</title>
		<meta charset="utf-8" />
					...
					<section id="main" class="wrapper">
						<div class="inner">
                          ...
                          <h2>Notifications</h2>
						    ...
						    <a href="add/add-notification.aspx" class="button">Add Notification</a>
						</div>
					</section>
