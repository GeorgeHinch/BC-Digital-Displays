<%@ Page Language="C#" AutoEventWireup="true" CodeFile="equipment-manager.aspx.cs" Inherits="settings_add_equipment_manager" %>
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
						  <h1 class="major">Event Manager</h1>
						  <span class="image fit"><img src="../images/event-1040.jpg" alt="" /></span>
                          <h2>Current Events</h2>
						    ...
						    <a href="add/add-event.aspx" class="button">Add Trainer</a>
                            <a href="restore/event-restore.aspx" class="button">Restore Trainer</a>
						</div>
					</section>
