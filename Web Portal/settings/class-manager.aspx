<%@ Page Language="C#" AutoEventWireup="true" CodeFile="class-manager.aspx.cs" Inherits="settings_class_manager" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Digital Display Admin - Class Manager</title>
		<meta charset="utf-8" />
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
						  <h1 class="major">Youth Class Manager</h1>
						  <span class="image fit"><img src="../images/trainer-1040.jpg" alt="" /></span>
                          <h2>Current Classes</h2>
                            <div class="table-wrapper">
                                <asp:Literal ID="classTable" runat="server" />
                            </div>
