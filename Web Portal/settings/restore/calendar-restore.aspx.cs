...
public partial class settings_restore_calendar_restore : System.Web.UI.Page
{
        ...
        if (v != null)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = "UPDATE [bcEvents] SET [deleted]='0' WHERE [id]='" + v.ToUpper() + "'";
    ...
    public List<bcEvents> GetData()
    {
        ...
        try
        {
            ...
            conn = new SqlConnection(connString);
            SqlCommand command = new SqlCommand("SELECT * FROM [bcEvents] WHERE [deleted]='1' ORDER BY orderTime", conn);
            conn.Open();
